...
const Features = ({ features }) => {
  return (
    <Container id="Features" className="py-5 my-5">
      <Button
        id="contact-btn"
        className="btn px-3 btn-success rounded-pill m-5 position-fixed bottom-0 end-0"
      >
        <Link
      ...
      <h1 data-aos="fade-in" id="feature-header" className="text-center mb-5">
        Through Psy-Awareness You can do the following:
      </h1>
        ...
        {features.map((item, id_name, color_class, data) => {
          ...
          return (
            ...
            >
              ...
              <p
                width="40%"
                className={color_class.concat(' text-center pt-5 mt-5')}
              >
                {item.caption}
              </p>
            </Col>
