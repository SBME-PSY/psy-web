...
const Download = ({mobile_app,google_play,app_store})=>{
    return(
        <Container id="Download" className="py-5">
            <Row>
                ...
                <Col xs={12} className="my-5" md={6} >
                        ...
                        <div id="stores" >
                            <a className="d-block text-center mt-5" href="https://www.google.com/"><img  width="200px"  src={google_play} alt="google play store link"></img></a>
