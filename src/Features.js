...
const Features=({features})=>{
    return(
        ...
        <Container id="Features" className="my-5">
            <Link to="/src/Contactus.js" target="_blank" rel="noopener noreferrer">Contact Us <FontAwesomeIcon icon={faMailBulk}/></Link>
            ...
            {features.map((item,id_name,color_class)=> {
                ...
                return(
                <Col xs={12} md={6} lg={4} key={item.id} id={id_name} className="mt-4 mx-2">
