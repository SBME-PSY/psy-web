            ...
            <Row className="py-5">
                ...
                <Col xs={12} md={6} className="px-5 py-3"  lg={4}>
                    ...
                    <ul className='d-flex  align-content-start flex-column'>
                        ...
                        <li className='fs-3 my-3 '><a href="https://www.linkedin.com/" className="text-decoration-none text-white">Contact Us <FontAwesomeIcon icon={faLinkedin} /> </a></li>
                        <li className='fs-3 my-3 '><a href="https://www.facebook.com/" className="text-decoration-none text-white">Contact Us <FontAwesomeIcon icon={faFacebook} /> </a></li>
                    </ul>
                </Col>
