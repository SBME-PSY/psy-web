...
const Contact = () => {
  ...
  return (
    <Container>
      {messageSent && (
        <Alert color="success">
          <span className="text-center shadow-lg top-0">
            <FontAwesomeIcon icon={faCheckCircle} /> Your message has been sent{' '}
          </span>
        </Alert>
      )}
          ...
          <Form onSubmit={sendEmail} className="py-5">
            ...
            <FormGroup className="my-3">
              ...
              <Input
                ...
                name="email"
                id="exampleEmail"
                placeholder="JohnDoe@expample.com"
              />
            </FormGroup>
            <FormGroup className="my-3">
              <Label>Subject</Label>
            ...
            <Button className="btn btn-danger rounded-pill m-5 position-fixed bottom-0 end-0">
              <Link to="/">
